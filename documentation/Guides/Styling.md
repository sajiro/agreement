[FluentUI](https://github.com/microsoft/fluentui/wiki/Theming) recommends to use the semantic slots as they won't update the values. This is the list of semantic slots with the default hex codes they use. This is what we reference in our theme file `..src\helpers\customTheme.ts`
